...
public class RetrieveGitHubWithTweets {
	...
	private static JSONArray requestGitHub(String endPointUrl) throws Exception {
		...
		try {
			...
			StringBuffer response = new StringBuffer(IOUtils.toString(connection.getInputStream(),"utf-8"));
	...
	private static String encodeKeys(String consumerKey, String consumerSecret) {
		try {
			...
			//String encodedKeys = new String(Base64.encodeBase64(String.format("%s:%s", URLEncoder.encode("","UTF-8"),URLEncoder.encode("","UTF-8")).getBytes()));
	 ...
	 * @throws 
	 */
	private static JSONObject fetchTimelineTweet(String endPointUrl, String bearerToken) throws MalformedURLException, IOException, JSONException  {
